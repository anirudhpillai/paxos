...
will help us meet all our requirements.
...
and to do away with the 'conveniece' parts. For Paxos, this is focusing on the
...
Yet, we can only be sure that the code follows the protocol.
...
we designed the inductive invariant but ran out of time to prove it.
...
protocol might itself be broken. In case of Paxos this will be the case that
the protocol never achieves consensus.
