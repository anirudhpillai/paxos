...
\subsubsection{1. Code the client application and the protocol}

\subsubsection{2. Prove the protocol and client application}

\subsubsection{3. Implement and prove the invariant}
