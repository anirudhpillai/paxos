...
We will now look at how one can use Disel to mechanise the proofs of a protocol.
There are three stages (1) - (3) and the more stages you complete the stronger
your proof will be. We also followed this process for proving Paxos. We completed
stages (1) and (2) and reached till proving the protocol in stage (3). Only proving
the inductive invariant in Disel was done.
